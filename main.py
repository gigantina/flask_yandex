                            ...
                            <div>
                                <form class="form.login_form" method="post">
                                    ...
                                    <div class="form-group form-check">
                                        ...
                                        <label class="form-check-label" for="1">Готов остаться на Марсе</label>
                                        <input type="checkbox" class="form-check-input" id="2" name="accept2">
                                        <label class="form-check-label" for="2">Готов остаться на Марсе</label>
                                        <input type="checkbox" class="form-check-input" id="3" name="accept3">
                                        <label class="form-check-label" for="3">Готов остаться на Марсе</label>
                                    </div>
                                    <div class="form-group">
